                    ...
                    {buyCoinArray?.map((item, index) => {
                        return (
                            <div className="table_main" key={index}>
                                ...
                                <p className="table_data"><img src={item?.image?.publicURL ? handleImage(item?.image?.publicURL) : handleImage(item?.image)} alt={item?.alt} className="logo" />{item?.description}</p>
